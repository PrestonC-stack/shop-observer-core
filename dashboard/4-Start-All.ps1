...
Start-Process powershell -WindowStyle Minimized -ArgumentList "-NoExit -Command", "cd 'C:\AI-RUNTIME\shop-observer-core'; .\cloudflared.exe tunnel run shop-tasks"
...
[System.Windows.MessageBox]::Show(
    ...
    "• Tunnel: https://tasks.callahanautoaz.net`n`n" +
