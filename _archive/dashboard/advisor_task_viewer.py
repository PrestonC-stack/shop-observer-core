        ...
        function renderNextActions(boardState) {
            ...
            container.innerHTML = jobs.map((job, index) => (
                '<div class="rounded-2xl bg-zinc-950 p-4">' +
                    ...
                    '<div class="mt-2 text-sm text-zinc-200">' + escapeHtml(job.hermes_next_action || job.next_action || "Keep momentum moving.") + "</div>" +
                "</div>"
            )).join("");
        }
...
=======
from app import app
>>>>>>> a6b3032faea9b5600681b23c34dab50635256b7d
